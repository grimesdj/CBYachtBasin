...
root_data = '~/OneDriveUNCW/DATA/';%'C:\Users\bcm3620\OneDrive - UNC-Wilmington\'; %This is the path to the CB YACHT BASIN shared folder on your machine
root_dir = '~/git/cbflood/'; % Path to the Post Processing folder on your machine
...
cfg = get_obs_config_DG(obsPeriod, adcpLoc, root_dir, root_data);
...
load(fullfile(cfg.out.adcp_data, [cfg.obsTag '_adcp_level_1.mat']), 'adcp_level_1');
load(fullfile(cfg.out.drifters_data, [cfg.obsTag '_drifters_level_1.mat']), 'drifters_level_1');
load(fullfile(cfg.out.adcp_data, [cfg.obsTag '_adcp_level_2.mat']), 'adcp_level_2');
...
save(fullfile(cfg.out.comp_data, [cfg.obsTag '_ROI_EOF.mat']), 'ROI_EOF');
save(fullfile(cfg.out.comp_data, [cfg.obsTag '_COMP.mat']), 'COMP');
