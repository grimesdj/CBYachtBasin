function cfg = get_obs_config_DG(obsPeriod, adcpLoc, root_dir, root_data)

% Point to post Porcessing folder
cfg.root_dir = fullfile(root_dir, 'code');

% Wherever you hva the ADCP data on your machine
cfg.root_data = fullfile(root_data, 'CB_YachtBasin');
...
switch [obsPeriod, adcpLoc]
    ...
    case { ['MarshMadness', 'NorthADCP'] }
        ...
        cfg.root_data = fullfile(cfg.root_data, 'MarshMadness');
        
        cfg.drifters_raw_dir = fullfile(cfg.root_data ,'DRIFTERS','DATA','Deployment_032625','RAW');
        disp('stopped here')
    ...
    case { ['NovDep', 'NorthADCP'] }
        ...
        cfg.root_data = fullfile(cfg.root_data, 'NovDep');
        
        cfg.drifters_raw_dir = fullfile(cfg.root_data ,'DRIFTERS','DATA','Deployment_110725','RAW');
        cfg.drifters_dep_times = fullfile(cfg.root_data ,'DRIFTERS','DATA','Deployment_110725','Dep_times','Dep_05_times.xlsx');
        
        
        cfg.adcp_input_dir = fullfile(cfg.root_data, 'AQD5459');
