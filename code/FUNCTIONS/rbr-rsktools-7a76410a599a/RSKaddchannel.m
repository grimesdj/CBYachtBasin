...
addParameter(p, 'unitPlainText', 'unknown', @ischar);
...
unit = p.Results.unit;
unitPlainText = p.Results.unitPlainText;
...
RSK = addchannelmetadata(RSK, 'shortName',shortName{:},'longName', channel,'units', unit); 
