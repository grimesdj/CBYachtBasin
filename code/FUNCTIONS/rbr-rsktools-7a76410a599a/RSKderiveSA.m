...
RSK = addchannelmetadata(RSK, 'shortName','cnt_00', 'longName','Absolute Salinity', 'units','g/kg', 'unitsPlainText','g/kg'); % nt_00 will need update when Ruskin sets up a shortname for SA
