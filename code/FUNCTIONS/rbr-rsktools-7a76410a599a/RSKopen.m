...
% 
% Please note that the hidden-channel data is accessible only when it is
% available in the RSK table. For the RSK with the type of EPdesktop, hidden-
% channel data is not stored in RSK file, thus, not readable even with
% readHiddenChannels = True.
%
% Inputs:
