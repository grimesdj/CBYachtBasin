...
RSK = addchannelmetadata(RSK, 'shortName','buoy00', 'longName','Buoyancy Frequency Squared','units', '1/s²','unitsPlainText','1.s-2');
N2col = getchannelindex(RSK, 'Buoyancy Frequency Squared');
RSK = addchannelmetadata(RSK, 'shortName','stbl00', 'longName','Stability', 'units','1/m','unitsPlainText','1/m');
