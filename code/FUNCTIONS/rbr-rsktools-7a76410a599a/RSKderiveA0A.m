...
for j=1:nbpr,
 ...
 for k=1:length(tend),
  ...
  RSK = addchannelmetadata(RSK,'shortName',drift_short_name,'longName',drift_long_name,'units',drift_units,'unitsPlainText',drift_unitsPlainText);
