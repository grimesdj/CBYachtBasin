...
% * Type |help RSKtools| to get an overview and take a look at the
% examples. This applies to the folder named "RSKtools". If the folder name changes, please type |help YourFolderName|.
