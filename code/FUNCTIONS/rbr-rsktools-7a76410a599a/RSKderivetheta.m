...
RSK = addchannelmetadata(RSK, 'shortName','cnt_00', 'longName','Potential Temperature','units', '°C', 'unitsPlainText','Degrees_C'); % cnt_00 will need update when Ruskin sets up a shortname for theta
