...
for k=1:n_paros,
    ...
    RSK = addchannelmetadata(RSK,'shortName',pres_short_name,'longName',pres_long_name,'units',pres_units,'unitsPlainText',pres_unitsPlainText);
    RSK = addchannelmetadata(RSK,'shortName',temp_short_name,'longName',temp_long_name,'units',temp_units,'unitsPlainText',temp_unitsPlainText);
