...
RSK = addchannelmetadata(RSK, 'shortName','scon00', 'longName','Specific Conductivity','units', 'µS/cm','unitsPlainText','uS/cm'); % cond08 is a temporary solution for Ruskin to read, will change in future
