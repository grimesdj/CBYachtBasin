...
rootDir    = '/Users/derekgrimes/OneDriveUNCW/Data/CB_YachtBasin/SummerFlood/ADCP/';
inputDirs  = {'AQD5459/','AQD2710/'};
inputFiles = {'CB_N601','CB_S601'};
outputNames= {'CB_N601','CB_S601'};
for jj=1:length(inputDirs)
clearvars -except rootDir inputDirs inputFiles outputNames jj
%
inputDir = [rootDir,inputDirs{jj}];
inputFile= inputFiles{jj};
...
if jj==1
    atmTime = [datenum('31-Jul-2026 16:00:00'), datenum('31-Jul-2026 17:20:00')];
    depTime = [datenum('31-Jul-2026 18:30:00'), datenum('29-Aug-2026 21:45:00')];
else
    atmTime = [datenum('31-Jul-2026 16:00:00'), datenum('31-Jul-2026 17:40:00')];
    depTime = [datenum('31-Jul-2026 18:30:00'), datenum('24-Aug-2026 18:35:33')];
end
